...
public class EditarTab2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Editando fila de la tabla de Percepciones que Aportaron");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarTab2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarTab2().setVisible(true);
            }
        });
    }
